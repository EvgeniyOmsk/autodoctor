<div class="footer__main">
    <div class="row row-eq-height">
        ...
        <div class="col-sm-6 col-md-4 col-lg-2 col-xl-2  consult_backToTop">
            <div class="footer__item"><a href="#" id="back-to-top"> <i class="fa fa-angle-up" aria-hidden="true"> </i><span>Вверх</span></a></div>
        </div>
    </div>
</div>
<div class="footer__copyright"><?= date('Y') ?> &copy; Все права защищены.</div>